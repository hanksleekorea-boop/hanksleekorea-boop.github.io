...
function render(input) {
  ...
  panel.innerHTML = `
    ...
    <p class="s1t-evidence"><b>추천 근거 여권:</b> 찬성 ${passport.reasonsFor.length}개 · 반대 ${passport.reasonsAgainst.length}개 · 미확인 ${passport.unknown.length}개 · 제휴/광고 순위 영향 없음. <a href="/shoppingscanner/quality-status/">전체 데이터 품질 상태</a> · <a href="/shoppingscanner/acceptance-center/">실제 수락 실행센터</a> · <a href="/shoppingscanner/innovation-lab/">2단계 혁신 실험실</a></p>`;
  panel.hidden = false;
}
